...
def cargar_equipos():
    equipos=[]
    try:
        with open("equipos.csv",mode="r", newline="", enconding="utf-8") as archivo:
...
def listar_equipos():
    ...
    for equipo in equipos:
        print(f"\n{equipo["equipo_id"]}-{equipo["nombre_equipo"]}-{equipo["categoria"]}-{equipo["estado_actual"]}-{equipo["fecha_registro"]}\n")
